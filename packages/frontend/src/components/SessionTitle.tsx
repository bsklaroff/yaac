...
/**
 * The session header's title. Normally a selectable label (so it can be copied)
 ...
 * flow. A blank value clears the title back to the prompt (per `renameSession`).
 *
...
export function SessionTitle({ sessionId, title, prompt }: {
  ...
  // 'New session' placeholder — editing an untitled session starts from its
