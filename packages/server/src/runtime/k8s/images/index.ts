...
// content-hash tags, the build-row registry, host GC) is #runtime/k8s/image-engine
// and sits BELOW #runtime/k8s/cluster, which builds netd's image before there is
// a cluster to build it in.
//
// Everything outside this directory imports `#runtime/k8s/images`; the
