...
// folder under `#runtime/k8s` talks to the cluster with. Everything outside
// this directory imports `#runtime/k8s/substrate`; the SEALED_FOLDERS lint
...
// packages/server/test/runtime/k8s/substrate/. Two modules are internal whole: the
