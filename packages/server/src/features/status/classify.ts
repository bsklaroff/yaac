...
import { isSessionTerminating } from './terminating'
import type { TmuxLiveness } from './liveness'
import type { SessionDeathCause, StaleSessionInfo } from '@yaac/shared/types'
 ...
 */
function deriveDeathCause(pod: SessionPod): SessionDeathCause {
