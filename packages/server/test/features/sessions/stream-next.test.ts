...
import type { WaitingSession } from '#features/sessions/waiting'
import type { ProjectMeta } from '@yaac/shared/types'

import type * as waitingModule from '#features/sessions/waiting'
import type * as statusModule from '#features/sessions/status'
import type * as podsModule from '#platform/k8s/pods'

vi.mock('#features/sessions/waiting', async () => {
  const actual = await vi.importActual<typeof waitingModule>('#features/sessions/waiting')
...
vi.mock('#features/sessions/status', async () => {
  const actual = await vi.importActual<typeof statusModule>('#features/sessions/status')
...
import { getSessionFirstMessage } from '#features/sessions/status'
