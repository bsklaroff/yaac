...
vi.mock('#features/images/image-prewarm', () => ({ prewarmProjectImage: vi.fn().mockResolvedValue(undefined) }))
...
import { prewarmProjectImage } from '#features/images/image-prewarm'
import {
