...
vi.mock('#features/worktrees/create', () => ({
...
import { claiming, inFlight, clearPrewarmStateForTests } from '#features/worktrees/prewarm'
...
import { cleanupWorktree, deleteWorktreeState } from '#features/worktrees/cleanup'
