...
vi.mock('#features/forwarders/port-detector', () => ({
...
import { addWorktreeForwarder } from '#features/forwarders/port-forwarders'
import { getUnforwardedPorts } from '#features/forwarders/port-detector'
import { addPortForwardToProjectConfig } from '#features/projects/local-config'
import { forwardWorktreePort } from '#features/forwarders/forward-port'
