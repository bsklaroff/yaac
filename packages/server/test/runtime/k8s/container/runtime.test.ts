...
// test/runtime/k8s/substrate/kubectl.test.ts.
...
import { _resetContainerRuntimeForTests } from '#runtime/k8s/container/runtime'
import { ensureKubernetes } from '#runtime/k8s/substrate/kubectl'
