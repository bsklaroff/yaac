...
vi.mock('#runtime/k8s/image-engine/image-builder', async (importOriginal) => ({
...
vi.mock('#runtime/k8s/cluster/cluster-cidrs', () => ({
...
vi.mock('#runtime/k8s/cluster/main-registry', async (importOriginal) => ({
