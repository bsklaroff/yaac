...
vi.mock('#drivers/k8s/cluster/activator', () => ({
...
import {
  ...
  reconcileVclusters,
} from '#drivers/k8s/cluster/vcluster-reconcile'
import { listWorktreeJobs, listWorktreePods } from '#drivers/k8s/substrate/pods'
import { getActivatorPodIp } from '#drivers/k8s/cluster/activator'
import {
  removeWorktreeVcluster,
  waitForVclusterKubeconfig,
} from '#drivers/k8s/cluster/vcluster'
import { listVclusterNamespaces } from '#drivers/k8s/substrate/vcluster-objects'
