...
vi.mock('@yaac/server/drivers/k8s/cluster/setup', () => {
...
import { ClusterSetupError, runClusterSetup } from '@yaac/server/drivers/k8s/cluster/setup'
import type * as clusterSetupModule from '@yaac/server/drivers/k8s/cluster/setup'
