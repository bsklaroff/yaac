...
| **workspace** | the same thing seen by the runtime layer, substrate-neutrally | the runtime observation vocabulary (`#runtime/contract`) — deliberately free of git and Kubernetes nouns (docs/plans/layered-server.md) |
