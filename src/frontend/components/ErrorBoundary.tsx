 ...
 * daemon/frontend version skew that drops a field the UI indexes into —
    ...
    return (
      <div className="flex h-full flex-col items-center justify-center gap-3 bg-bg p-6 text-center">
        ...
        <div className="max-w-md text-sm text-text-faint">
          The app hit an unexpected error. This can happen when the desktop app
          and the daemon are running different versions.
        </div>
