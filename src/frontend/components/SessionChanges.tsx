...
import { indexDiffsByPath, type DiffLine, type ParsedFileDiff } from '@/frontend/lib/diff'
import { LoadingIcon, WarningIcon, ChevronIcon } from '@/frontend/lib/icons'
 ...
 * the daemon so it updates as work lands; read-only for now.
 */
