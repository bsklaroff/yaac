 ...
 * (main.ts hides them). Three dots — close / minimize / zoom — monochrome at
 * rest; hovering the row lights them up in the familiar red/amber/green and
 * reveals their glyphs, like the real thing. The row is a drag handle; the
