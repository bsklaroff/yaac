import { connectAuthAgent } from '@/auth-daemon/connection'
import { killAllToolLogins, setToolLoginPersistence } from '@/auth-daemon/tool-login'
import { killAllToolInstalls } from '@/auth-daemon/tool-install'
import {
  authDaemonLockPath,
  isPidLive,
  readAuthDaemonLock,
